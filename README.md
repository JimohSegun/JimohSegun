# 💫 About Me:
Hi there<br>![](https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif)<br><br>My name is JIMOH SEGUN THOMPSON<br><br>==========================================================================================================<br><br>Quantitative Researcher || Data Scientist<br><br>-----------------------------------------------------------<br><br>🌍 I'm based in lagos, Nigeria, <br> <br> A highly motivated individual with expertise in quantitative analysis, statistics, financial modeling, and programming languages, passionate about analyzing financial markets, optimizing trading strategies, and managing risks using advanced statistical methods. <br> <br>🖥️ See my portfolio at (https://websegun.netlifys.app)<br>
